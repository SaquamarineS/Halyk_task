...
project.cs - название файла, ниже написана команда для компиляции .exe файла.

```bash
csc /out:app.exe project.cs
```
...
На основе ссылки указанной ниже я взял константы: threshold1, threshold2, threshold3, threshold4 чтобы сканировать бумаги формата А4.
